...
if (IE||NS6) {document.write('<DIV ID="basessm" style="visibility:hidden;Position : Relative ;Z-Index : 20;width:'+(menuWidth+barWidth+10)+'px"><DIV ID="thessm" style="Position : Absolute ;Left : '+(-menuWidth)+'px ;Top : 0 ;Z-Index : 20;" onmouseover="moveOut()" onmouseout="moveBack()">')}
...
ssmItems[0] = ["<div id='flashContent' >" +
"<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' width='600' height='100' id='handguide' align='middle' >" +
"<param name='movie' value='../SWF/handguide.swf' />" +
...
"<!--[if !IE]>-->" +
"<object type='application/x-shockwave-flash' data='../SWF/handguide.swf' width='600' height='100' >" +
"<param name='movie' value='../SWF/handguide.swf' />" +
"<param name='quality' value='high' />" +
"<param name='bgcolor' value='#f3f3f3' />" +
"<param name='play' value='true' />" +
