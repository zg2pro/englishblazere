...
$(document).ready(function () {
	...
	$('#leftpart4datebanner, #userinfo').addClass( "ui-widget-header" );

	$('input[type=submit]:not(.viewicon),button').addClass('ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only');
	
  $('#mainnav').addClass( "ui-widget-header" );
	$('#menuleft').addClass( "ui-accordion ui-widget ui-helper-reset ui-accordion-icons" );
	$('#menuleft>li').addClass( "ui-accordion-header ui-helper-reset ui-state-default ui-state-active ui-corner-top" );	
	
	$('.td-galitem-title').addClass('ui-state-default ui-corner-top');
  $('.rowmod').addClass( 'ui-icon ui-icon-document' );
	$('.rowdel').addClass( 'ui-icon ui-icon-trash' );
	$('.rowmod').removeClass( 'rowmod action' );
	$('.rowdel').removeClass( 'rowdel action' );                                                                                    
