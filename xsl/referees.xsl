...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<dl>		
         ...
         <xsl:element name="a">
				<xsl:attribute name="href"><xsl:value-of select="profile"/></xsl:attribute>
				<xsl:value-of select="person"/>
			</xsl:element>,
                     <i> <xsl:value-of disable-output-escaping="yes"  select="title"/></i>
                    </dt>
          <dd>
           <small><xsl:value-of select="text"/></small><br/><br/>
          </dd>
